...
#sed -i 's@#define NGINX_VER.*NGINX_VERSION$@#define NGINX_VER          "svipc/" NGINX_VERSION@' src/core/nginx.h
#sed -i 's@Server: nginx@Server: svipc@' src/http/ngx_http_header_filter_module.c
