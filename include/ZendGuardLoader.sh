...
if [ "$OS_BIT" == '64' ] ;then
    if [ "$PHP_main_version" == '5.6' ];then
        src_url=http://mirrors.svipc.com/Autoscripts/zend-loader-php5.6-linux-x86_64.tar.gz && Download_src
    ...
    if [ "$PHP_main_version" == '5.5' ];then
        src_url=http://mirrors.svipc.com/Autoscripts/zend-loader-php5.5-linux-x86_64.tar.gz && Download_src
    ...
    if [ "$PHP_main_version" == '5.4' ];then
        src_url=http://mirrors.svipc.com/Autoscripts/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-x86_64.tar.gz && Download_src
    ...
    if [ "$PHP_main_version" == '5.3' ];then
        src_url=http://mirrors.svipc.com/Autoscripts/ZendGuardLoader-php-5.3-linux-glibc23-x86_64.tar.gz && Download_src
    ...
    if [ "$PHP_main_version" == '5.6' ];then
        src_url=http://mirrors.svipc.com/Autoscripts/zend-loader-php5.6-linux-i386.tar.gz && Download_src
    ...
    if [ "$PHP_main_version" == '5.5' ];then
        src_url=http://mirrors.svipc.com/Autoscripts/zend-loader-php5.5-linux-i386.tar.gz && Download_src
    ...
    if [ "$PHP_main_version" == '5.4' ];then
        src_url=http://mirrors.svipc.com/Autoscripts/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-i386.tar.gz && Download_src
    ...
    if [ "$PHP_main_version" == '5.3' ];then
        src_url=http://mirrors.svipc.com/Autoscripts/ZendGuardLoader-php-5.3-linux-glibc23-i386.tar.gz && Download_src
