...
do
    echo
    read -p "Please input domain(example: www.svipc.com): " domain
...
if [ "$moredomainame_yn" == 'y' ]; then
    ...
    do
        echo
        read -p "Type domainname,example(svipc.com www.svipc.com): " moredomain
